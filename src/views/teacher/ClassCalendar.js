...
import {
    ...
    TableRow, AccordionDetails, Grid, 
    Typography, Accordion, AccordionSummary, Box
} from '@mui/material';

import ExpandMoreIcon from '@mui/icons-material/ExpandMore';
import CalendarSubject from './teacher-calender/CalendarSubject';
...
const rows = [
    createData('1', <CalendarSubject title='SHDC' />, 'LTVC', 'Tập làm văn', 'Thể dục', 'Khoa học'),
